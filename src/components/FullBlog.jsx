 ...
 *  - Desktop: wider container, image as a banner, content flows naturally underneath
 *
 * Usage:
 *   <FullBlog blog={blog} />
 */
  ...
  return (
    <article
      className="mx-auto max-w-4xl overflow-hidden rounded-3xl border-2 border-gray-200 bg-white
                 shadow-sm motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-2
                 motion-safe:duration-500 my-8 lg:my-12"
    >
      {/* Back link */}
      ...
      <div className="flex flex-col p-6 lg:p-10">
        ...
        <h1 className="mt-4 text-2xl font-bold leading-snug text-gray-900 lg:text-4xl">
          {blog.title}
        </h1>

        <p className="mt-6 whitespace-pre-line leading-7 text-gray-600 lg:text-lg lg:leading-8">
          {blog.content}
        </p>
      </div>
    </article>
