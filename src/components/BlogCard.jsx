  ...
  return (
    ...
    >
          ...
          {blog.image_url && (
            <img
              ...
              className="h-full w-full object-cover transition-transform duration-500
                         ease-out group-hover:scale-105 border border-gray-200 rounded-lg"
            />
          )}
        </div>
      </Link>
      ...
      <div className="flex flex-1 flex-col p-6 lg:p-8">
        ...
        {/* Title */}
        <h2
          className="mt-4 text-xl font-bold leading-snug text-gray-900
                     transition-colors group-hover:text-blue-600 lg:text-2xl"
        >
        ...
        <div className="mt-6">
          <Button
            asChild
            className="rounded-full bg-blue-600 px-5 py-2.5 font-semibold
                       text-white transition-all duration-200 hover:gap-3 hover:bg-blue-700"
          >
            <Link
              to={`/blog/${blog.id}`}
